...
| ----------------------------------------------------------------------- | ----------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------- |
| [Spring Boot Registration System](https://github.com/samuelmbp/java-springboot-registration-system)          | Practice with Java and Spring Boot by creating a login registration backend system | `.java` `.java mail` `.spring boot` `.spring security` `.spring data jpa` `.postgresql`              |
